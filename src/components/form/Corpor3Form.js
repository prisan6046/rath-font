                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <div className="row mb-2">
                                    ...
                                    <div className="col-lg-8">
                                        <input type="radio" name="type_check" id="1"/> <label className="mb-0" htmlFor="1">ห้ามใช้ยานพาหนะชั่วคราว</label> <br/>
                                        <input type="radio" name="type_check" id="2"/> <label className="mb-0" htmlFor="2">ห้ามใช้ยานพาหนะเด็ดขาด</label>
                                    </div>
                                </div>
